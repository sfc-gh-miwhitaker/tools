...
-- NOTE: CORTEX_AISQL_USAGE_HISTORY replaces deprecated CORTEX_FUNCTIONS_USAGE_HISTORY (GA Dec 2025)
...
CREATE OR REPLACE STREAMLIT SFE_CORTEX_CALCULATOR
    FROM '@SNOWFLAKE_EXAMPLE.SFE_CORTEX_CALC.SFE_STREAMLIT_STAGE'
    MAIN_FILE = 'app.py'
